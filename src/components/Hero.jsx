...
import { codeExpamples, floatingCards } from "../data/CodeExample";
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute bottom-20 right-0 sm:right-10 w-64 sm:w-96 h-64 sm:96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div className="">
            <div className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700">
              ...
              <span className="text-xs sm:text-sm text-blue-300">
                Inroducing CodeFlow AI
              </span>
            </div>
            <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-4 sm:md-6 animate-in slide-in-from-bottom duration-700 delay-100 leading-tight">
            ...
            <p className="text-md sm:text-base lg:text-lg text-gray-400 max-x-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
          ...
          <div className="relative order-2 w-full">
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
              <div className="bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] lg:h-[450px] sm:h-[350px] border border-white/5">
                {/* IDE HEADER */}
              ...
              {/* FLOATING CARDS */}
              <div
                className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 w-72 ${currentFloatingCard.bgColor} backdrop-blur-xl rounded-lg p-4  border border-white/20 shadow-2xl`}
              >
