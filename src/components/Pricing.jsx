      ...
      <div className="max-w-7xl mx-auto ">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20 ">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
            Chose the perfect plan for your need. All plans include a 14-day
            free trial.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => (
            ...
            >
              <div className="absolute inset-0  bg-gradient-to-br from-white/7 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full -translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 pointer-events-none rounded-xl"></div>
              {plan.mostPopular && (
